...
function Reletedmobiles({reletedmobile}) {
  ...
  return (
   ...
   <div ref={sliderRef} className=" slider w-full h-auto bg-white flex flex-row justify-center overflow-hidden p-2 overflow-x-scroll">
       {
          reletedmobile && reletedmobile?.map((item,i)=>{
               return(
                   <NavLink  key={i} to={`/mobile/${item.id}`}>
                       <div className="group min-w-[250px] mr-3 h-[300px] flex flex-col bg-white shadow-[0_0_4px_black] overflow-x-hidden hover:border-[1px] relative hover:border-orange-500 hover:shadow-[0_0_4px_orange]  ">
                      ...
                      <img src={`/mobile/${item?.url}`} alt="jj" className="h-[150px] w-[100px]  object-cover" />
